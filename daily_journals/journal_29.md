...
Today's Progress:
    ...
    1. Learning With Nature:
        Save only the one park code that applies to the specified saved lesson plan. Update Lesson model and database.

        Style navbar as well as login and register pages. 
