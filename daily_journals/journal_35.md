...
Today's Progress:
    ...
    1. Learning With Nature:
        Change profile() function in views.py to update_profile(). 
        When 'Hello, User' link is clicked, the user-profile div is displayed and the user may click one of two buttons to change their username or password if desired.
